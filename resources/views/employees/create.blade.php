...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Lengkapi data karyawan di bawah ini</p>
        </div>
    </div>
        ...
        <form action="{{ route('employees.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required
                        class="w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('name') border-red-500 @else border-gray-300 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                            class="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('phone') border-red-500 @else border-gray-300 @enderror"
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3"
                    class="w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('address') border-red-500 @else border-gray-300 @enderror"
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-primary-500 @error('salary_type') border-red-500 @else border-gray-200 @enderror has-[:checked]:border-primary-600 has-[:checked]:bg-primary-50">
                        <input type="radio" name="salary_type" value="per_kg" {{ old('salary_type', 'per_kg') === 'per_kg' ? 'checked' : '' }} class="sr-only peer" required onchange="toggleSalaryFields()">
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-primary-500 @error('salary_type') border-red-500 @else border-gray-200 @enderror has-[:checked]:border-primary-600 has-[:checked]:bg-primary-50">
                        <input type="radio" name="salary_type" value="per_day" {{ old('salary_type') === 'per_day' ? 'checked' : '' }} class="sr-only peer" onchange="toggleSalaryFields()">
                        <div class="flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div id="salary-per-kg-field">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="base_salary_per_kg" name="base_salary_per_kg" value="{{ old('base_salary_per_kg') }}" step="0.01" min="0"
                            class="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('base_salary_per_kg') border-red-500 @else border-gray-300 @enderror"
                            placeholder="0">
                    </div>
                ...
                <div id="salary-per-day-field">
                    ...
                    <div class="relative">
                        <span class="absolute inset-y-0 left-3 flex items-center text-gray-400 text-sm">Rp</span>
                        <input type="number" id="base_salary_per_day" name="base_salary_per_day" value="{{ old('base_salary_per_day') }}" step="0.01" min="0"
                            class="w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 @error('base_salary_per_day') border-red-500 @else border-gray-300 @enderror"
                            placeholder="0">
                    </div>
            ...
            <div>
                ...
                <div class="flex gap-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="is_active" value="1" {{ old('is_active', '1') === '1' ? 'checked' : '' }} class="w-4 h-4 text-primary-600 focus:ring-primary-500" required>
                        <span class="text-sm text-gray-700 font-medium">Aktif</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="is_active" value="0" {{ old('is_active') === '0' ? 'checked' : '' }} class="w-4 h-4 text-primary-600 focus:ring-primary-500">
