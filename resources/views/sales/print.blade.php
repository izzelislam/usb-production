    ...
    <div class="slip-container">
        ...
        <div class="header">
            <div class="company-info">
                ...
                <p>Telp: (022) 1234567 | Email: sales@usbcake.com</p>
            </div>
        ...
        <div class="info-grid">
            <div class="info-column">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $sale->buyer->name }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Alamat</span>
                    <span class="info-value">{{ $sale->buyer->address ?? '-' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Telepon</span>
                    <span class="info-value">{{ $sale->buyer->phone ?? '-' }}</span>
                </div>
            </div>
            <div class="info-column">
        ...
        <div class="total-section">
            <div class="total-row final">
                ...
                <span class="total-value">Rp {{ number_format($sale->grand_total, 0, ',', '.') }}</span>
            </div>
            <div class="terbilang">
                # {{ ucwords(\NumberFormatter::create('id', \NumberFormatter::SPELLOUT)->format($sale->grand_total)) }} Rupiah #
            </div>
        </div>
        ...
        <div class="footer">
            <div class="signature-box">
                ...
                <div class="signature-line">{{ $sale->buyer->name }}</div>
            </div>
            <div class="signature-box">
                <div class="signature-title">Hormat Kami</div>
                <div class="signature-line">Admin Penjualan</div>
            </div>
        </div>
    </div>
    @endforeach
