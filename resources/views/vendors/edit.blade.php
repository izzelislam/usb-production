...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui data supplier</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <form action="{{ route('vendors.update', $vendor) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="address" id="address" rows="3" 
                                ...
                                placeholder="Alamat lengkap supplier...">{{ old('address', $vendor->address) }}</textarea>
                        </div>
                        @error('address')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
